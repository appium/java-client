...
public interface SupportsUnlockSuccessTimeoutOption<T extends BaseOptions<T>> extends
     ...
     */
    default T setUnlockSuccessTimeout(Duration timeout) {
        return amend(UNLOCK_SUCCESS_TIMEOUT_OPTION, timeout.toMillis());
    }
     ...
     */
    default Optional<Duration> getUnlockSuccessTimeout() {
        return Optional.ofNullable(
                toDuration(getCapability(UNLOCK_SUCCESS_TIMEOUT_OPTION))
        );
    }
}
